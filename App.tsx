...
import { ImageSrcAtom, ShareStream, StreamSourceAtom, InitFinishedAtom, BumpSessionAtom, IsUploadedImageAtom, DetectTypeAtom } from './atoms';
...
function App() {
  ...
  const [, setStreamSource] = useAtom(StreamSourceAtom);
  ...
  }, [imageSrc, stream, setStream, setStreamSource]);
